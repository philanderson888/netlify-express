...
router.get('/', (req, res) => {
  ...
  res.write(`<p>server3 .. app.use('/') at <a href="https://netlify-express-serverless.netlify.app/.netlify/functions/server3" target="_self">https://netlify-express-serverless.netlify.app/.netlify/functions/server3</a></p>`);

  res.write(`<p>server4 at <a href="https://netlify-express-serverless.netlify.app/.netlify/functions/server4" target="_self">https://netlify-express-serverless.netlify.app/.netlify/functions/server4</a></p>`);
